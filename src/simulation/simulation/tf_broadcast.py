...
class StaticTFPublisher(Node):
    def __init__(self)->None:
        ...
        self.timerFrame3 = self.create_timer(3.0, self.publishFrame3)
    ...
    def initializeTransforms(self)->list[TransformStamped]:
        ...
        transforms = []
        transform1To2 = self.createTransform("frame_1", "frame_2", x=2.0, y=0.0, z=0.0)
        transforms.append(transform1To2)
        self.frame3Transform = self.createTransform("frame_1", "frame_3", x=4.0, y=1.0, z=0.0)
        transform1To4 = self.createTransform("frame_1", "frame_4", x=3.0, y=2.0, z=1.0)
